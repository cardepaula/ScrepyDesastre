...
class MaingSpider(scrapy.Spider):
    ...
    start_urls = ['http://www.justificando.com/?s=desastre+samarco&search_button=Buscar+']
...
####################Paginação################
    ...
    def parse_article(self, response):
        ...
        try:
            ...
            dataPublicacao = self.data_parse(response.css("span.entry-tdate::text").extract_first()) 
            conteudo  = ""
